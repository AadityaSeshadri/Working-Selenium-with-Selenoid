...
//public class HomePage extends BaseClass{
	public class ActiveReposPage {
	  final static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(ActiveReposPage.class);
	 //WebDriver driver = Hooks.driver;
	WebDriverWait wait  ;

	@FindBy(how= How.XPATH, using="//*[text()='active repos with > 10 updates']")
